<?php
    ...
    $mail->Host       = 'smtp.mail.ru';                     // Настраиваем SMTP-сервер на отправку через 
    $mail->SMTPAuth   = true;                                    // Включить аутентификацию SMTP 
    $mail->Username   = 'bocharov-as@mail.ru';                     // Имя пользователя SMTP 
    $mail->Password   = '2375025115Qa';                               // Пароль SMTP 
    ...
    //Откого письмо
    $mail->setFrom('bocharov-as@mail.ru', 'БочаровА');
    //Кому отправить
    $mail->addAddress('19.artem.12@mail.ru');
    //Тема письма
